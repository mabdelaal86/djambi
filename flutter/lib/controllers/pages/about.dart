  ...
  Future<void> onLoad() async {
    ...
    await addAll([
      TextElementComponent.fromDocument(
        ...
        size: Vector2(bodySize.x - _bodyPadding.horizontal, (bodySize.y - _bodyPadding.vertical) / 4 * 3),
        style: DocumentStyle(
          text: InlineTextStyle(color: Configs.textColor, fontSize: Configs.defaultFontSize),
        ),
